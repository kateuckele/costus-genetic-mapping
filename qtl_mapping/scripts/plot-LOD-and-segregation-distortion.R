...
perm      <- readRDS("./results/processed_data/scanone_1000perm.rds") # load permutation thresholds
...
for (trait in traits) {
  ...
  pdf(paste0("./results/figures/QTL_segdist_", trait, ".pdf"), width = 7, height = length(keep_chr)*4.5)
