...
Combine the summary dataframes for bract, petal, and labellum into a single dataframe.
```{r merge}
# Merge bract and petal summaries by 'id'
joined_df <- summary_bract %>%
...
write.csv(joined_df, "./results/processed_data/spectral_shape_descriptors.csv", 
