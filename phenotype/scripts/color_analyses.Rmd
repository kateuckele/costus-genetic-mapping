...
plot(bract_bee_colspace, col = spec2rgb(bract_spec_scalemax))
plot(petal_bee_colspace, col = spec2rgb(petal_spec_scalemax))
plot(labellum_bee_colspace, col = spec2rgb(labellum_spec_scalemax))
